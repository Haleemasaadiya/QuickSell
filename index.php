...
if(!isset($_SESSION['UID'])){ //if UID is not available in session we need to include 2 functionalities
  
  include "register.php";  //post request contains  <input type="email" class="form-control box" id="email" name="email" placeholder="" /> it will excutes
  include "login.php"; //post request contains a name = loginemail , then this will work login.php will excutes

}

if(isset($_POST['title'])){
  include "upload_product.php"; //when product upload this functionality is
}
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.min.js" integrity="sha384-ODmDIVzN+pFdexxHEHFBQH3/9/vQ9uori45z4JjnFsRydbmQbmL5t1tQ0culUzyK" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <script>
      if ( window.history.replaceState ) { //stops resubmission and when we refresh it don't show prompt
